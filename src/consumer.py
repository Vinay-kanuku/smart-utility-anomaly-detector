...
import time
import io
from avro.io import BinaryDecoder, DatumReader, AvroTypeException
import avro.schema
...
if __name__ == "__main__":
    consumer = TransactionConsumer(bootstrap_servers='localhost:29092', group_id='transaction_group', topic='transactions')
